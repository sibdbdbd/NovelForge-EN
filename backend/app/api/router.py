...
from app.api.endpoints import story_charter as story_charter_ep
...
api_router.include_router(story_charter_ep.router, prefix="/story-charter", tags=["story-charter"])
